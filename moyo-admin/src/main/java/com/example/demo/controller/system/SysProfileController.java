...
import com.example.demo.config.MoYoConfig;
...
import com.example.demo.common.utils.file.FileUploadUtils;
import com.example.demo.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(MoYoConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
