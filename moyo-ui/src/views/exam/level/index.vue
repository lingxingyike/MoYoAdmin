...
<script>
import { listLevel, getLevel, delLevel, addLevel, updateLevel } from "@/api/exam/level";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('exam/level/export', {
        ...this.queryParams
